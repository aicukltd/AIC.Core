...
public interface ITypedCache<TKey, TValue> : IDisposable
{
    ...
    Task<TValue> FindAsync(Func<TValue, bool> predicate);
    ...
    Task<TValue[]> FindAllAsync(Func<TValue, bool> predicate);
    ...
    /// <param name="slidingExpireTime">Sliding expire time</param>
    /// <param name="absoluteExpireTime">Absolute expire time</param>
    void Set(KeyValuePair<TKey, TValue>[] pairs, TimeSpan? slidingExpireTime = null,
    ...
    /// <param name="slidingExpireTime">Sliding expire time</param>
    /// <param name="absoluteExpireTime">Absolute expire time</param>
    Task SetAsync(KeyValuePair<TKey, TValue>[] pairs, TimeSpan? slidingExpireTime = null,
        TimeSpan? absoluteExpireTime = null);
