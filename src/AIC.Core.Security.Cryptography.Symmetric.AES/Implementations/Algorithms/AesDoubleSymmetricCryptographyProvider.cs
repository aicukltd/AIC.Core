...
public class AesDoubleSymmetricCryptographyProvider : IDoubleSymmetricCryptographyProvider
{
    ...
    public AesDoubleSymmetricCryptographyProvider(ISymmetricCryptographyProvider primaryCryptographyProvider,
